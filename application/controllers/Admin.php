...
class Admin extends CI_Controller {
   ...
   public function index()
   {
      ...
      $data['total_banner'] = $this->my->countRows('banner');
		$data['total_umkm'] = $this->my->countRows('umkm');
		$data['total_rw'] = $this->my->countRows('rw');
      $data['chart'] = $this->admin->areaChart();
		$data['rwUMKM'] = $this->admin->pieChart();
   ...
   {
      $data['title'] = 'RW';
      $data['page'] = 'article/rw';
      $data['datatable'] = 'article/rw-datatable';
      $this->load->view('back/layouts/app', $data);
   }
   ...
   {
      $data['title'] = 'RT';
      $data['page'] = 'article/rt';
      $data['datatable'] = 'article/rt-datatable';
		$data['rw'] = $this->umkm->getRw();
      $this->load->view('back/layouts/app', $data);
   }
   ...
   {
      $data['title'] = 'UMKM';
      $data['page'] = 'article/umkm';
      $data['datatable'] = 'article/umkm-datatable';
      $this->load->view('back/layouts/app', $data);
   }
