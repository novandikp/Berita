    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container">
            ...
            <div class="row">
               <div class="col">
                  <h3 class="page-header"> <?= isset($input->id) ? 'Edit Posting': 'Tambah Posting' ?></h3>
               </div>
            </div>
            ...
            <?= form_open_multipart($form_action) ?>
               ...
               <a href="<?= base_url('admin/posting') ?>" class="btn btn-sm btn-secondary mb-4">Kembali</a>
               <button type="submit" class="btn btn-sm btn-primary float-right mb-4">Simpan</button>
