<div class="container">
   ...
   <div class="row mt-3">
      <div class="col">
         <a href="<?= base_url("back/umkm/create") ?>" class="btn btn-success btn-sm mb-1"><i class="fas fa-plus"></i> Tambah</a>
         <button class="btn btn-outline-secondary btn-sm mb-1" onclick="reload_table()">
            <i class="fas fa-sync-alt"></i> Reload
         </button>
         <button class="btn btn-outline-danger btn-sm mb-1" onclick="bulk_delete()">
            <i class="fas fa-trash"></i> Multiple Delete
         </button>
			<a href="<?= base_url("back/umkm/export") ?>" class="btn btn-outline-success btn-sm mb-1" >
  ...
  <br>
   ...
   <div class="table-responsive">
      <table id="tableUmkm" class="table table-bordered"  cellspacing="0" width="100%">
         <thead>
         <tr>
...
<!-- Modal -->
<div class="modal fade" id="modalUmkm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
