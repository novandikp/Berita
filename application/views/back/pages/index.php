<div class="container-fluid">
	...
	<div class="col-xl-6 col-md-6 mb-4">
      <div class="card border-left-secondary shadow h-100 py-2">
         <div class="card-body">
            <div class="row no-gutters align-items-center">
               <div class="col mr-2">
                  <div class="text-s font-weight-bold text-secondary text-uppercase mb-1">RW</div>
                  <div class="h mb-0 font-weight-bold text-gray-800">
                     <?= $total_rw ?>  
                  </div>
               </div>
	...
	<div class="col-xl-6 col-md-6 mb-4">
      <div class="card border-left-warning shadow h-100 py-2">
         <div class="card-body">
            <div class="row no-gutters align-items-center">
               <div class="col mr-2">
                  <div class="text-s font-weight-bold text-warning text-uppercase mb-1">UMKM</div>
                  <div class="h mb-0 font-weight-bold text-gray-800">
                     <?= $total_umkm ?>  
                  </div>
               </div>
   ...
   <div class="row">
      ...
      <!-- <div class="col-xl-12 col-lg-12" id="chartPostingan">
  ...
  <!-- Area Chart -->
  <div class="col-xl-12 col-lg-12" id="chartUMKM">
         <div class="card shadow mb-4 mt-5">
            <!-- Card Header - Dropdown -->
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
               <h6 class="m-0 font-weight-bold text-primary">Persentase UMKM di RW</h6>
            </div>
            <!-- Card Body -->
            <div class="card-body">
						<div class="chart-area">
							<canvas id="pieChart" height="100vh"></canvas>
						</div>
            </div>
         </div>
      </div>
